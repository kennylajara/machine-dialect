...
class TestLiterals:
    ...
    @pytest.mark.xfail(reason="CFG parser doesn't support list literals")
...
>> Give back _"small"_."""
    ...
    @pytest.mark.xfail(reason="While loops not implemented in CFG parser")
...
> Set i to i + _1_."""
    ...
    @pytest.mark.xfail(reason="CFG parser doesn't support for each loops")
