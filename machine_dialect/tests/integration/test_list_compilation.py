...
"""
        ...
        try:
            ...
            constant_values = [val for tag, val in bytecode_module.chunks[0].constants]
            assert 100 in constant_values
            assert 200 in constant_values
            assert 300 in constant_values
