...
class BytecodeGenerator:
    ...
    def generate_module(self, mir_module: MIRModule) -> Module:
    ...
    def _gen_conditional_jump(self, inst: ConditionalJump) -> None:
        ...
        # Invert condition and jump to false branch
        self.current_chunk.write_byte(Opcode.NOT)
...
def generate_bytecode(mir_module: MIRModule) -> Module:
    ...
    return generator.generate_module(mir_module)
