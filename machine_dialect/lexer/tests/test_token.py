...
class TestToken:
    def test_token_with_line_and_position(self) -> None:
        ...
        token = Token(type=TokenType.MISC_IDENT, literal="test", line=1, position=0)
    ...
    def test_token_equality_with_location(self) -> None:
        ...
        token1 = Token(type=TokenType.LIT_INT, literal="42", line=1, position=0)
        token2 = Token(type=TokenType.LIT_INT, literal="42", line=1, position=0)
        token3 = Token(
    ...
    def test_token_creation_with_defaults(self) -> None:
        ...
        token = Token(type=TokenType.OP_PLUS, literal="+", line=1, position=0)
