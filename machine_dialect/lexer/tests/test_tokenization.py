...
class TestLexer:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("details", [Token(TokenType.KW_DETAILS, "details", line=1, position=0)]),
            ("empty", [Token(TokenType.KW_EMPTY, "empty", line=1, position=0)]),
            ("entrypoint", [Token(TokenType.KW_ENTRYPOINT, "entrypoint", line=1, position=0)]),
            ("filter", [Token(TokenType.KW_FILTER, "filter", line=1, position=0)]),
            ("prompt", [Token(TokenType.KW_PROMPT, "prompt", line=1, position=0)]),
            ("summary", [Token(TokenType.KW_SUMMARY, "summary", line=1, position=0)]),
            ("template", [Token(TokenType.KW_TEMPLATE, "template", line=1, position=0)]),
            ...
            ("actions", [Token(TokenType.KW_ACTION, "actions", line=1, position=0)]),
            ("apply", [Token(TokenType.KW_CALL, "apply", line=1, position=0)]),
            ("behavior", [Token(TokenType.KW_BEHAVIOR, "behavior", line=1, position=0)]),
            ("Boolean", [Token(TokenType.KW_BOOL, "Boolean", line=1, position=0)]),
            ("Float", [Token(TokenType.KW_FLOAT, "Float", line=1, position=0)]),
            ("Floats", [Token(TokenType.KW_FLOAT, "Floats", line=1, position=0)]),
            ("from", [Token(TokenType.KW_FROM, "from", line=1, position=0)]),
            ("Integer", [Token(TokenType.KW_INT, "Integer", line=1, position=0)]),
            ("Integers", [Token(TokenType.KW_INT, "Integers", line=1, position=0)]),
            ("interaction", [Token(TokenType.KW_INTERACTION, "interaction", line=1, position=0)]),
            ("List", [Token(TokenType.KW_LIST, "List", line=1, position=0)]),
            ...
            ("Numbers", [Token(TokenType.KW_NUMBER, "Numbers", line=1, position=0)]),
            ...
            (
                ...
                [
                    ...
                    Token(TokenType.MISC_IDENT, "x", line=1, position=0),
                    Token(TokenType.OP_TWO_STARS, "**", line=1, position=0),
                    Token(TokenType.OP_GT, "is greater than", line=1, position=0),
                    Token(TokenType.LIT_INT, "0", line=1, position=0),
                    Token(TokenType.PUNCT_COMMA, ",", line=1, position=0),
